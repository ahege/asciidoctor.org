...
= Architectural Guidelines for OpenSCENARIO
// standard version
:icons: font
:stem: latexmath
[NOTE] 
...
[red]*Test* This section defines the basic and the core architecture of the OpenSCENARIO standard. It establishes the scope of the standard and describes the concepts, relations and logical interfaces to external systems.
--
...
ifdef::backend-gitlab[]
This is HTML
endif::[]

The domain of _traffic simulation_ is consisidered the target domain for OpenSCENARIO.

=== Artifacts

The domain of _traffic simulation_ covers an extensive amount of concepts like technical and sociological models, traffic participants and the area of testing. Examples are sensor models, environmental models, driver models, kinematical models, traffic models, sociological actor models etc. But also units under test, testing preconditions, expected test results etc.
...
The domain of _traffic simulation_ covers an extensive amount of concepts like technical and sociological models, traffic participants and the area of testing. Examples are sensor models, environmental models, driver models, kinematical models, traffic models, sociological actor models etc. But also units under test, testing preconditions, expected test results etc.
The domain of _traffic simulation_ covers an extensive amount of concepts like technical and sociological models, traffic participants and the area of testing. Examples are sensor models, environmental models, driver models, kinematical models, traffic models, sociological actor models etc. But also units under test, testing preconditions, expected test results etc.
The domain of _traffic simulation_ covers an extensive amount of concepts like technical and sociological models, traffic participants and the area of testing. Examples are sensor models, environmental models, driver models, kinematical models, traffic models, sociological actor models etc. But also units under test, testing preconditions, expected test results etc.<<Artifacts>>
